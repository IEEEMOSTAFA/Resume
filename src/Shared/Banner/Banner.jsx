...
const Banner = () => {
    return (
        ...
        <div className="hero min-h-screen bg-black pt-20">
            <div className="hero-content flex-col lg:flex-row-reverse max-w-7xl mx-auto px-4 lg:px-8">
                ...
                <div className="flex-1 text-white">
                    <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold mb-4 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent animate-fade-in">
                        Full Stack Developer
                    </h1>
                    
                    <p className="text-lg sm:text-xl lg:text-2xl mb-2 text-gray-300 animate-fade-in-delayed">
                    ...
                    <div className="mb-8 animate-fade-in-delayed-4">
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <button 
                                className="btn btn-outline btn-md sm:btn-lg text-white border-white hover:bg-white hover:text-black transition-all duration-300 hover:scale-105"
                                onClick={() => {
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                            ...
                            <div className="flex gap-3 sm:gap-4">
                                ...
                                <a 
                                    ...
                                    className="btn btn-circle btn-sm sm:btn-md bg-white/20 backdrop-blur-sm border border-white/30 text-white hover:bg-white hover:text-black hover:border-white transition-all duration-300 hover:scale-110 tooltip tooltip-top"
                                    data-tip="GitHub"
                                >
